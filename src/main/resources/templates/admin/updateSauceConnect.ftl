...
<div class="paddedClearer"></div>
   ...
   A new version of the <a href="http://saucelabs.com/docs/sauce-connect">Sauce Connect</a> library is available.  Click 'Update Sauce Connect' to install it within Bamboo.
